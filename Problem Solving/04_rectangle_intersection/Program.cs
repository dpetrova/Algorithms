...
//You are given N rectangles in the plane. 
//The rectangles are parallel to the coordinate axes and each is defined by its coordinates: {minX, maxX, minY, maxY}. 
//Write a program to find the total area of all intersections (areas that belong to more than one of the initial rectangles)
